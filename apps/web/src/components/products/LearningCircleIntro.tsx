...
export default function LearningCircleIntro() {
  ...
  const themes: Theme[] = useMemo(
    () => [
      {
        title: '定制学习路径',
        desc: '根据你的基础与目标，定制学习路线与对应课程，从入门到实战稳步进阶。',
        tag: '学习',
      },
      {
        title: '主流短线思维',
        desc: '聚焦市场主线、主流方向与核心个股，理解力胜于模式战法，快速抓住要点。',
        tag: '方法',
      },
      {
        title: '盘前精选早报',
        desc: '每日早报视频精选关键资讯，提前掌握市场动态，知道“今天看什么”。',
        tag: '资讯',
      },
      {
        title: '盘中实时解盘',
        desc: '盘中动态解读与观点补充，从交易回测、操作风格、聚焦核心等角度帮助把握机会与风险。',
        tag: '实战',
      },
      {
        title: '盘后深度复盘',
        desc: '每日视频复盘市场走势，总结规律，提升盘感，把经验沉淀成可复用能力。',
        tag: '复盘',
      },
      {
        title: '情绪节点讨论',
        desc: '对当下情绪节点做定性，围绕参与方向共同讨论，让你学习阶段不再“盲走”。',
        tag: '讨论',
      },
      {
        title: '早晚知识卡片/视频',
        desc: '推送游资前辈语录与知识卡片，碎片时间也能高效学习与拓展认知。',
        tag: '日更',
      },
      {
        title: '宇硕板块助手',
        desc: '免费使用，一键整理热门板块与核心个股，节省大量信息筛选时间。',
        tag: '工具',
      },
      {
        title: '13,000+知识库',
        desc: '情绪超短知识库持续更新，覆盖短线交易核心逻辑，从理论到案例提升实战能力。',
        tag: '资料',
      },
    ],
    []
    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-br from-[#ff8c42]/10 via-white to-white rounded-2xl p-5 sm:p-6 shadow-sm border border-[#ff8c42]/20">
        ...
        <p className="mt-3 text-gray-700 leading-relaxed">
          学习圈已经稳定运行第三年，各方面非常完善，口碑一直很好。我们把“学习路径、日常资讯、盘中盘后实战、情绪节点讨论、工具与知识库”
          做成体系化闭环，让学习阶段不再迷路。
        </p>
      ...
      <div className="bg-white rounded-2xl p-5 sm:p-6 shadow-sm">
        ...
        <div className="space-y-3 text-gray-700 leading-relaxed">
          <p>2019 年开始学股票，笔记写了好几本，课程啃了几百个小时好几遍，才知道走错了路，耽误了三年。</p>
          <p>
            股票难在学习阶段无法确定自己走的对不对。我也曾非常希望有人引路，给一条清晰的学习路线：先学什么，再学什么，怎么复盘，怎么验证。
          </p>
          <p>所以我把百余套内容从易到难重新整理成路线，并不断在学习圈里迭代——让你少走弯路、稳定进步。</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-5 sm:p-6 shadow-sm">
        ...
        <div className="mt-5 rounded-xl bg-[#ff8c42]/10 border border-[#ff8c42]/20 p-4 text-sm text-gray-800">
          一句话总结：从资讯解读到实战技巧，从系统学习到社群互动，这里是你炒股进阶的一站式成长圈。
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-5 sm:p-6 shadow-sm">
        ...
        <p className="text-gray-700 leading-relaxed">
          回访超 300 人，不断听取社群成员建议；每个人的建议都编入小册，一步一步继续优化。内容也持续完善，精选更合适的教材，更符合你的学习需求。
        </p>
