          ...
          {[
            {
              name: '学员A',
              duration: '加入8个月',
              content: '之前自己摸索了两年，走了不少弯路。加入学习圈后才发现原来有这么清晰的学习路线，现在每天跟着早报和复盘走，慢慢有了自己的节奏感。',
            },
            {
              name: '学员B',
              duration: '加入1年',
            ...
            },
            {
              name: '学员C',
              duration: '加入5个月',
              content: '知识库很全，遇到不懂的概念直接搜基本都能找到。复盘视频也很实在，讲的都是干货，不会浪费时间。',
            },
            {
              name: '学员D',
              duration: '加入1年半',
              content: '从月费升级到年费了，主要是觉得值。学习路径帮我省了很多时间，不用再到处找资料。板块助手也好用，每天复盘效率提高了不少。',
            },
          ].map((review) => (
