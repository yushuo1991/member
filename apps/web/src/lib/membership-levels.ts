...
export const PRODUCTS: Product[] = [
  ...
  // 单独购买产品
  {
    ...
    icon: '📊',
    imageUrl: 'https://wuqq-obsidian.oss-cn-shanghai.aliyuncs.com/obsidian%E5%9B%BE%E7%89%87/20231120155629.png',
    requiredLevel: 'none',
  ...
  },
  {
    ...
    icon: '📋',
    imageUrl: 'https://image.taoguba.com.cn/img/2024/01/21/4puk0so56fez.png_760w.png',
    requiredLevel: 'none',
    priceType: 'standalone',
