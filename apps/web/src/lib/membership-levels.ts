...
export const PRODUCTS: Product[] = [
  // 会员专属产品
  {
    ...
    icon: '👥',
    imageUrl: '/products/xuexiquan-cover.webp',
  ...
  },
  {
    ...
    icon: '💻',
    imageUrl: '/products/bankuaizhushou-cover.webp',
    requiredLevel: 'monthly',
    priceType: 'both',
  ...
  },
  {
    ...
    icon: '📊',
    imageUrl: '/products/bk-cover.webp',
  ...
  },
  {
    ...
    icon: '🧠',
    imageUrl: '/products/xinli-cover.webp',
  ...
  },
  {
    ...
    icon: '📈',
    imageUrl: '/products/fuplan-cover.webp',
  ...
  },
  {
    ...
    icon: '🎓',
    imageUrl: '/products/peibanying-cover.webp',
    requiredLevel: 'lifetime',
    priceType: 'membership',
    trialEnabled: false,
    trialCount: 0,
  ...
  // 单独购买产品
  {
    ...
    icon: '📊',
    imageUrl: '/products/qingxubiaoge-cover.webp',
    requiredLevel: 'none',
  ...
  },
  {
    ...
    icon: '📋',
    imageUrl: '/products/fupanbanmian-cover.webp',
    requiredLevel: 'none',
    priceType: 'standalone',
  ...
  },
  {
    ...
    icon: '📝',
    imageUrl: '/products/jiandanfupan-cover.webp',
    requiredLevel: 'none',
    priceType: 'standalone',
