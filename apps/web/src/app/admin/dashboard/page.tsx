    ...
    <div className="space-y-4 max-w-[1600px]">
      ...
      <div className="grid grid-cols-4 gap-3">
        ...
        <a
          ...
          className="bg-white p-4 rounded-xl border border-gray-200 hover:border-[#007AFF] hover:shadow-md transition-all duration-200 text-center group"
        >
          <div className="w-10 h-10 bg-green-50 group-hover:bg-[#007AFF] rounded-lg flex items-center justify-center mx-auto mb-2 transition-colors">
          ...
          <p className="text-xs font-medium text-gray-900">产品管理</p>
        </a>
      </div>
    </div>
  );
