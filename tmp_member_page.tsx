      ...
      <main className="pt-20 sm:pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6 sm:mb-8">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-2">浼氬憳涓績</h1>
            <p className="text-sm sm:text-lg text-gray-600">绠＄悊鎮ㄧ殑浼氬憳鏉冪泭</p>
          </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-4">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-3 sm:p-4">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-0.5">
                  {memberLevel === 'lifetime' ? '鈭? : memberLevel === 'none' ? '-' : daysRemaining}
                </h3>
                <p className="text-gray-600 text-xs sm:text-sm">鍓╀綑澶╂暟</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-3 sm:p-4">
                ...
                <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-0.5">
                  {memberLevel === 'lifetime' ? '姘镐箙' : memberLevel === 'none' ? '-' : expiryDate?.toLocaleDateString('zh-CN')}
                </h3>
                <p className="text-gray-600 text-xs sm:text-sm">鍒版湡鏃ユ湡</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-3 sm:p-4">
                ...
                <p className="text-gray-600 text-xs sm:text-sm">鍙敤浜у搧</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-3 sm:p-4">
                ...
                <p className="text-gray-600 text-xs sm:text-sm">鍓╀綑璇曠敤</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100 mb-5 sm:mb-6">
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900">宸茶幏寰楃殑璁块棶鏉冮檺</h3>
              <span className="text-xs sm:text-sm text-gray-500">{grantedMembershipProducts.length} 涓?/span>
            </div>
                    ...
                    <div className="flex items-center min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-xs text-green-600">
                          {status.accessType === 'membership' && '浼氬憳鏉冮檺'}
                          {status.accessType === 'purchased' && '宸茶喘涔?}
                          {status.accessType === 'trial' && `璇曠敤${status.trialRemaining}娆}
                        </div>
                      </div>
                    </div>
                    <Link
          ...
          {/* Trial Status */}
          <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100 mb-5 sm:mb-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">璇曠敤棰濆害</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-5 sm:gap-6">
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">浜у搧璁块棶鏉冮檺</h3>
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-gray-600">
                            {status.hasAccess ? (
                              ...
                              `闇€瑕?{levelConfig?.name || product.requiredLevel}`
                            )}
                          </p>
                        </div>
                      </div>
              ...
              {/* 鍗曠嫭璐拱浜у搧 */}
              <h4 className="text-sm sm:text-base font-semibold text-gray-900 mt-5 mb-3">鍗曠嫭璐拱浜у搧</h4>
              <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-center flex-1 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-gray-600">
                            {purchased ? (
                              <span className="text-blue-600">宸茶喘涔?/span>
                            ) : (
                              product.standalonePrices?.lifetime
                                ? `楼${product.standalonePrices.lifetime}涔版柇`
                                : '鍙喘涔?
                            )}
                          </p>
                        </div>
